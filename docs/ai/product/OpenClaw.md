...
OpenClaw（俗称“小龙虾”）是一款在 2026 年初迅速走红的开源、自托管自主 AI 智能体（AI Agent）项目。它由奥地利工程师 Peter Steinberger 开发，旨在让用户在自己的设备上运行一个能“真正做事”的 AI 助手。 [1, 2, 3] 
...
发展历程
   ...
   3. 开发者动向：2026 年 2 月，创始人 Peter Steinberger 宣布加入 OpenAI，项目随后移交给独立基金会进行社区化运作。 [1, 4, 6, 9, 10, 11] 
